...
import { mock, expect } from 'https://deno.land/x/expect@v0.2.10/mod.ts';
...
const addLinesToAssertionError = async (origin: string, assertionError: AssertionError): Promise<AssertionError> => {
  try {
...
export const step = (t: Deno.TestContext, text: string, method: (t: Deno.TestContext) => void | Promise<void>) => {
